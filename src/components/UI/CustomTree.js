...
import CustomButton from "views/app/comp/components/Button";
...
class Tree extends Component {
    ...
    render() {
        ...
        const customSearchMethod = ({ node, searchQuery }) =>
            searchQuery &&
            node.description.toLowerCase().indexOf(searchQuery.toLowerCase()) >
                -1;
        ...
        return (
            <div
                style={{ height: this.props.height ? this.props.height : 500 }}
            >
                <form
